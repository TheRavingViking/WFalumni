...
<a href="www.s1105718.hbo-almere.nl/setPass?auth={{ $email }}" >Wachtwoord instellen</a>
            ...
            <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td style="padding: 25px 0; text-align: center;">
                        <a style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif; font-size: 16px; font-weight: bold; color: #2F3133; text-decoration: none; text-shadow: 0 1px 0 white;" href="http://wfalumni.dev" target="_blank">
                            WFalumni
                        </a>
                    </td>
                </tr>
                                    ...
                                    <table style="width: 100%; margin: 30px auto; padding: 0; text-align: center;" align="center" width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td align="center">
                                                ...
                                                <a href="http://wfalumni.dev/password/reset/98d34989f8b29f96d53258104dc0e562bf3805292ba6f96ca71b4e0c38f7bb49"
                                    ...
                                    <table style="margin-top: 25px; padding-top: 25px; border-top: 1px solid #EDEFF2;">
                                        <tr>
                                            <td style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif;">
                                                ...
                                                <p style="margin-top: 0; color: #74787E; font-size: 12px; line-height: 1.5em;">
                                                    <a style="color: #3869D4;" href="http://wfalumni.dev/password/reset/98d34989f8b29f96d53258104dc0e562bf3805292ba6f96ca71b4e0c38f7bb49" target="_blank">
                                                        http://wfalumni.dev/password/reset/98d34989f8b29f96d53258104dc0e562bf3805292ba6f96ca71b4e0c38f7bb49
                                                    </a>
                                                </p>
                                            </td>
                                        </tr>
                        ...
                        <table style="width: auto; max-width: 570px; margin: 0 auto; padding: 0; text-align: center;" align="center" width="570" cellpadding="0" cellspacing="0">
                            <tr>
                                <td style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif; color: #AEAEAE; padding: 35px; text-align: center;">
                                    <p style="margin-top: 0; color: #74787E; font-size: 12px; line-height: 1.5em;">
                                        &copy; 2017
                                        <a style="color: #3869D4;" href="http://wfalumni.dev" target="_blank">WFalumni</a>.
                                        All rights reserved.
                                    </p>
                                </td>
                            </tr>
