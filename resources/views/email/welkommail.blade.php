            ...
            <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td style="padding: 25px 0; text-align: center;">
                        <a style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif; font-size: 16px; font-weight: bold; color: #2F3133; text-decoration: none; text-shadow: 0 1px 0 white;"
                           href="http://wfalumni.dev" target="_blank">
                            WFalumni
                        </a>
                    </td>
                </tr>
                ...
                <tr>
                                    ...
                                    <table style="width: 100%; margin: 30px auto; padding: 0; text-align: center;"
                                        ...
                                        <tr>
                                            <td align="center">
                                                ...
                                                <a href="www.s1105718.hbo-almere.nl/setPass?auth={{ $email }}"
                 ...
                 text-align: center; text-decoration: none; -webkit-text-size-adjust: none; background-color: #3869D4;"
                                    ...
                                    <!-- Outro -->
                                    <p style="margin-top: 0; color: #74787E; font-size: 16px; line-height: 1.5em;">
                                        Als je dit niet aangevraagd hebt, kan je deze mail.
                                    </p>
                                            ...
                                            <td style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif;">
                                                ...
                                                <p style="margin-top: 0; color: #74787E; font-size: 12px; line-height: 1.5em;">
                                                    <a style="color: #3869D4;"
                                                       href="www.s1105718.hbo-almere.nl/setPass?auth={{ $email }}"
                                                       target="_blank">
                                                        www.s1105718.hbo-almere.nl/setPass?auth={{ $email }}
                                                    </a>
                                                </p>
                                            </td>
                                        </tr>
                        ...
                        <table style="width: auto; max-width: 570px; margin: 0 auto; padding: 0; text-align: center;"
                            ...
                            <tr>
                                <td style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif; color: #AEAEAE; padding: 35px; text-align: center;">
                                    <p style="margin-top: 0; color: #74787E; font-size: 12px; line-height: 1.5em;">
                                        &copy; 2017
                                        <a style="color: #3869D4;" href="http://wfalumni.dev"
                                           target="_blank">WFalumni</a>.
                                        All rights reserved.
                                    </p>
                                </td>
                            </tr>
